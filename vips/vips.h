...
int vips_reduce_bridge(VipsImage *in, VipsImage **out, double xshrink, double yshrink)
{
...
int vips_pngsave_bridge(VipsImage *in, void **buf, size_t *len, int strip, int compression, int quality, int interlace, int palette)
{
